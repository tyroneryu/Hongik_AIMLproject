...
# ===== 경로 설정 =====
repo_dir = '/Users/taeyunryu/Desktop/aimlp/dataset'
rules_path = '/Users/taeyunryu/Desktop/aimlp/capa/rules'
output_csv = '/Users/taeyunryu/Desktop/aimlp/output/dataset.csv'
label_csv = '/Users/taeyunryu/Desktop/aimlp/label.csv'
capa_script_path = '/Users/taeyunryu/Desktop/aimlp/capa/capa/main.py'
yara_rules_path = "/Users/taeyunryu/Desktop/aimlp/yara/malware_rules.yar"
...
def analyze_with_capa(binary_path, rules_path, yara_rules_path, all_yara_matches):
    try:
        ...
        yara_matched_lines = run_yara(binary_path, yara_rules_path)
        yara_matched = [line.split()[0] for line in yara_matched_lines if line.strip()]
        yara_features, all_yara_matches = update_yara_features(all_yara_matches, yara_matched)
        ...
        for k, v in yara_features.items():
            row[k] = v

        return row, all_yara_matches
    except Exception as e:
...
def analyze_and_merge():
    ...
    for file_path in all_files:
        row, all_yara_matches = analyze_with_capa(file_path, rules_path, yara_rules_path, all_yara_matches)
